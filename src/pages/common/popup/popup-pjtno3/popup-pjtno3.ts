...
export class PopupPjtno3Page {
  ...
  retrive(flag){
    ...
    let param = JSON.stringify({company_cd: this.g_company[0].COMPANY, plant_cd: this.plant_cd, ym_fr: this.ym_fr, ym_to: this.ym_to, c_code: this.g_user.c_code, page: this.page});
