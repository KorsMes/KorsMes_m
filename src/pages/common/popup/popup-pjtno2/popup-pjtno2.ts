...
export class PopupPjtno2Page {
  ...
  retrive(flag){
    ...
    let param = JSON.stringify({company_cd: this.g_company[0].COMPANY, plant_cd: this.plant_cd, pjtno_fr: this.pjtno_fr, pjtno_to: this.pjtno_to, c_code: this.g_user.c_code, page: this.page});
